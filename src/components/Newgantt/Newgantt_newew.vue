<template>
  <div class="q-pa-sm">
<!--    {{ datas }}-->
<!--    <q-btn @click="boton">boton</q-btn>-->
<!--    <a href="#dia11">qweqeqw</a>-->
    <div class="q-pa-xs">
      <div class="row">
...
export default {
  ...
  methods: {
    ...
    updateTimeLines(timeA, timeB, item) {
      // window.locationf=`#dia12`;
      // window.open(`#dia12`);
      // console.log(item);
      location.href=`#dia${item.name}`;
      this.bar2_data = item;
      this.timeLines = [
        {
          time: timeA
    ...
    addTask() {
      for (let i = 0; i < this.datas.length; i++) {
        ...
        console.log(
          dayjs(`${this.date_ini} +03:00`, "DD-MM-YYYY HH:mm Z").toString()
        );
  ...
  async created() {
    ...
    // console.log("String", dayjs('05/02/2021 1:02:03 PM +03:00', 'MM/DD/YY H:mm:ss A Z').toString())
